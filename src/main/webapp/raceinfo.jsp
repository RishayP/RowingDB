...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary t1ext-uppercase fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top">EPS Rowing Database raceinfo</a>
    ...
    <!--  
 	...
 	<div class="position-relative center-table">      <!--   "position-absolute top-50 start-50 translate-middle p-4">  --> 
 		<table>
		<tbody id="tableBody">
		 <tr>
            <th>EventType</th>
