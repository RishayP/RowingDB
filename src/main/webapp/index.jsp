...
<body id="page-top">
	<!-- Navigation-->
	<nav
		class="navbar navbar-expand-lg bg-secondary t1ext-uppercase fixed-top"
		id="mainNav">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="./retrieve.jsp">Race Info</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="./stats.jsp">Stats</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="./login.jsp">Log In</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="https://s3-us-west-2.amazonaws.com/sportshub2-uploads-prod/files/sites/2592/2020/10/06194855/eastside-prep-20298.png"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To The EPS <br /> Rowing Database</h1>
			<!-- Icon Divider-->
			...
			<p class="masthead-subheading font-weight-light mb-0">
				Statistics in Eagle Sports for Rowing</p>
		</div>
	</header>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						10613 NE 38th PL, <br /> Kirkland, WA 98033
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
					<h4 class="text-uppercase mb-4">Recent Updates</h4>
					<p class="lead mb-0">
						Coming Soon! <br />
					</p>
				...
				<!-- Footer About Text-->
				<div class="col-lg-4">
					<h4 class="text-uppercase mb-4">About Database</h4>
					<p class="lead mb-0">
						This database is free to use, but is not affiliated with 
						<a href="https://www.eastsideprep.org/">EPS</a>.
					</p>
				</div>
			</div>
		</div>
